appexe : movement/square.o graphic/enemy.o utils/calculus.o utils/textTools.o main.o
	gcc -g movement/square.o graphic/enemy.o utils/calculus.o utils/textTools.o main.o -o appexe -lglut -lGLU -lGL 
...
utils/textTools.o : utils/textTools.c
