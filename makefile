appexe : movement/square.o graphic/enemy.o utils/calculus.o utils/textTools.o utils/timerTools.o view/start-menu.o view/game.o view/end-game.o view/navigation.o main.o
	gcc -g movement/square.o graphic/enemy.o utils/calculus.o utils/textTools.o utils/timerTools.o view/start-menu.o view/game.o view/end-game.o view/navigation.o main.o -o appexe -lglut -lGLU -lGL 
...
view/game.o : view/game.c graphic/enemy.h movement/square.h utils/calculus.h utils/textTools.h utils/timerTools.h view/navigation.h
	gcc -g -c view/game.c -o view/game.o -Wall -std=c99
view/start-menu.o : view/start-menu.c movement/square.h utils/textTools.h view/navigation.h
